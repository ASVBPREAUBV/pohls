...
var (
	...
	episodePattern       = regexp.MustCompile(`(?i)([ex]([0-9]{2})(?:[^0-9]|$))`)
	...
	audioPattern         = regexp.MustCompile(`(?i)(MP3|DD5\.?1|Dual[\- ]Audio|LiNE|DTS|AAC[.-]LC|AAC(?:\.?2\.0)?|AC3(?:\.5\.1)?)`)
	...
	otherPatterns        = regexp.MustCompile(`(?i)READNFO|TiTAN|MAXPRO|UpScaled|iNTERNAL`)
)
